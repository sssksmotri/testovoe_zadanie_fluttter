                          ...
                          Row(
                            children: [
                              IconButton(onPressed:(){},
                                icon:  Image.asset("assets/icons/plus.png",width: 40,height: 40,),
                                ...
                                child: TextField(
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon:  Image.asset(
                                      "assets/icons/chuvak.png"
                                    ),
                                  ),
                                ),
                              ),
                              IconButton(onPressed: (){}, icon: const Icon(Icons.mic_rounded,size: 40,color: Color(0xFF8D8D8D),))
